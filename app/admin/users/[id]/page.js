...
//             fetchApplicantStats(data.user._id);
//           } else if (data.user.role === "company") {
//             fetchCompanyStats(data.user._id);
//           }
...
//   const fetchApplicantStats = async (applicantId) => {
//     try {
//       const response = await fetch(`/api/admin/users/${applicantId}/stats`);
//       if (response.ok) {
//         const data = await response.json();
//         if (data.success) {
//           setStats(data.stats);
...
//               {/* Additional Info */}
//               {(user.companyName || user.location) && (
...
//                           <p className="text-lg font-bold text-gray-900 mt-1">{stats.applications || 0}</p>
//                         </div>
//                         <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-blue-500 to-cyan-400 flex items-center justify-center">
//                           <FiFileText className="text-white text-lg" />
//                         </div>
//                       </div>
//                       <div className="mt-2 text-xs text-gray-500">Total job applications</div>
//                     </div>
...
//                           <p className="text-lg font-bold text-gray-900 mt-1">{stats.jobsPosted || 0}</p>
//                         </div>
...
//                         </div>
//                       </div>
//                       <div className="mt-2 text-xs text-gray-500">Total jobs posted</div>
//                     </div>
...
//                           <p className="text-lg font-bold text-gray-900 mt-1">{stats.interviews || 0}</p>
//                         </div>
...
//                           <p className="text-lg font-bold text-gray-900 mt-1">{stats.successRate || 0}%</p>
//                         </div>
...
//                         </div>
//                       </div>
//                       <div className="mt-2 text-xs text-gray-500">Application success</div>
//                     </div>
//                   </div>
...
//                           </div>
//                           <div>
//                             <p className="text-sm font-medium text-gray-900">Applied for Senior Developer</p>
...
//                           />
//                         ) : (
//                           <p className="text-sm text-gray-900 bg-gray-50 p-2 rounded">{user.location || "Not provided"}</p>
//                         )}
//                       </div>
//                     </div>
//                   </div>
...
//                             />
//                           ) : (
//                             <p className="text-sm text-gray-900 bg-gray-50 p-2 rounded">{user.companyName}</p>
//                           )}
//                         </div>
...
//                             />
//                           ) : (
//                             <p className="text-sm text-gray-900 bg-gray-50 p-2 rounded">{user.industry || "Not specified"}</p>
//                           )}
//                         </div>
...
//                               rows="3"
//                               className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 
//                                 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 resize-none"
//                               placeholder="Brief description about the company..."
//                             />
//                           ) : (
//                             <p className="text-sm text-gray-900 bg-gray-50 p-2 rounded whitespace-pre-line">
...
//                           <p className="text-xs text-gray-500 mt-0.5">Chrome on Windows • 2 hours ago</p>
//                         </div>
//                       </div>
//                     ))}
//                   </div>
...
//                         </div>
//                         <button className="px-4 py-2 bg-gradient-to-r from-blue-500 to-cyan-600 text-white rounded-lg 
//                           hover:from-blue-600 hover:to-cyan-700 transition-all duration-200 text-sm font-medium">
//                           Enable 2FA
//                         </button>
//                       </div>
...
//                           <p className="text-xs text-gray-500 mt-0.5">3 active sessions</p>
//                         </div>
//                         <button className="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 
//                           transition-all duration-200 text-sm font-medium">
//                           View All
...
//                 <span className={`inline-flex items-center gap-1 ${user.emailVerified ? 'text-emerald-600' : 'text-amber-600'}`}>
//                   {user.emailVerified ? (
//                     <>
...
//                 <span className="text-xs text-gray-600 font-mono">{user.lastIp || 'N/A'}</span>
//               </div>
//             </div>
//           </div>
...
//                 <span className="text-xs text-gray-600 font-mono">{user._id?.substring(0, 8)}...</span>
//               </div>
...
//               <button className="w-full flex items-center justify-between p-3 text-sm text-rose-600 hover:bg-rose-50 rounded-lg transition-colors">
//                 <div className="flex items-center gap-2">
...
//   const downloadApprovalDocument = () => {
//     if (user?.companyProfile?.approvalDocument) {
//       const link = document.createElement('a');
//       link.href = `data:application/pdf;base64,${user.companyProfile.approvalDocument}`;
//       link.download = `approval-document-${user._id}.pdf`;
...
//                   <div className="flex items-center gap-3 mb-2">
//                     <h2 className="text-lg font-bold text-gray-900">{user.name}</h2>
//                     <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium ${user.role === 'admin' ? 'bg-amber-100 text-amber-800' :
//                       user.role === 'company' ? 'bg-violet-100 text-violet-800' :
//                         'bg-emerald-100 text-emerald-800'
//                       }`}>
//                       {getRoleIcon(user.role)}
...
//                       <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium ${user.companyStatus === 'approved' ? 'bg-emerald-100 text-emerald-800' :
//                         user.companyStatus === 'pending' ? 'bg-amber-100 text-amber-800' :
//                           'bg-rose-100 text-rose-800'
//                         }`}>
//                         {getStatusIcon(user.companyStatus)}
...
//                     className={`py-3 px-1 border-b-2 font-medium text-sm transition-colors ${activeTab === "applicant"
//                       ? "border-blue-500 text-blue-600"
//                       : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"
//                       }`}
//                   >
...
//                     className={`py-3 px-1 border-b-2 font-medium text-sm transition-colors ${activeTab === "company"
//                       ? "border-blue-500 text-blue-600"
//                       : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"
//                       }`}
//                   >
...
//                             </div>
//                           </div>
//                           <div className="mt-2 text-xs text-gray-500">{user?.companyProfile?.companyName || 'Not set'}</div>
//                         </div>
...
//                               <p className="text-lg font-bold text-gray-900 mt-1">{user?.companyProfile?.location ? '✓' : '✗'}</p>
//                             </div>
//                             <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-amber-500 to-orange-400 flex items-center justify-center">
//                               <FiMapPin className="text-white text-lg" />
//                             </div>
//                           </div>
//                           <div className="mt-2 text-xs text-gray-500">{user?.companyProfile?.location || 'Not provided'}</div>
//                         </div>
//                       </>
//                     ) : (
//                       <>
...
//                           <input
//                             type="tel"
//                             value={editableUser?.profile?.phone || ""}
...
//                           />
//                         ) : (
//                           <p className="text-sm text-gray-900 bg-gray-50 p-2 rounded">{user?.profile?.phone || "Not provided"}</p>
//                         )}
//                       </div>
...
//                           <input
//                             type="text"
//                             value={editableUser?.profile?.location || ""}
...
//                           />
//                         ) : (
//                           <p className="text-sm text-gray-900 bg-gray-50 p-2 rounded">{user?.profile?.location || "Not provided"}</p>
//                         )}
//                       </div>
//                     </div>
//                   </div>
...
//                         <div className="flex items-center justify-between">
//                           <div>
//                             <h4 className="text-sm font-medium text-gray-900">{user.profile.resume.fileName}</h4>
//                             <p className="text-xs text-gray-500 mt-1">
//                               {user.profile.resume.fileType} • {(user.profile.resume.fileSize / 1024).toFixed(2)} KB
//                             </p>
//                           </div>
//                           <button
//                             onClick={() => {
//                               const link = document.createElement('a');
//                               link.href = `data:application/pdf;base64,${user.profile.resume.fileData}`;
//                               link.download = user.profile.resume.fileName;
//                               document.body.appendChild(link);
//                               link.click();
//                               document.body.removeChild(link);
//                             }}
...
//                     <div>
//                       <h3 className="text-sm font-semibold text-gray-900 mb-4">Approval Document</h3>
//                       <div className="p-4 border border-gray-200 rounded-lg">
//                         <div className="flex items-center justify-between">
//                           <div>
//                             <h4 className="text-sm font-medium text-gray-900">Company Verification Document</h4>
//                             <p className="text-xs text-gray-500 mt-1">
//                               {user.companyProfile.approvalDocumentType || "Document"} •
//                               Status: <span className={`font-medium ${user.companyProfile.approvalDocumentStatus === 'approved' ? 'text-emerald-600' :
//                                 user.companyProfile.approvalDocumentStatus === 'pending' ? 'text-amber-600' :
//                                   'text-rose-600'
//                                 }`}>
//                                 {user.companyProfile.approvalDocumentStatus?.toUpperCase()}
//                               </span>
//                             </p>
//                           </div>
//                           <button
//                             onClick={downloadApprovalDocument}
//                             className="px-3 py-1.5 bg-blue-500 text-white rounded hover:bg-blue-600 transition-colors text-xs flex items-center gap-1"
//                           >
//                             <FiDownload className="text-sm" />
//                             Download
...
//               <div className="flex items-center justify-between">
//                 <span className="text-sm text-gray-600">Account Status</span>
//                 <span className={`text-xs font-medium px-2 py-1 rounded-full ${user.status === 'active' ? 'bg-emerald-100 text-emerald-800' :
//                   user.status === 'suspended' ? 'bg-rose-100 text-rose-800' :
//                     'bg-gray-100 text-gray-800'
//                   }`}>
//                   {user.status?.charAt(0).toUpperCase() + user.status?.slice(1) || 'Active'}
...
//                 <span className={`text-xs font-medium px-2 py-1 rounded-full ${user.role === 'admin' ? 'bg-amber-100 text-amber-800' :
//                   user.role === 'company' ? 'bg-violet-100 text-violet-800' :
//                     'bg-emerald-100 text-emerald-800'
//                   }`}>
//                   {user.role?.toUpperCase()}
...
//                   <span className={`text-xs font-medium px-2 py-1 rounded-full ${user.companyStatus === 'approved' ? 'bg-emerald-100 text-emerald-800' :
//                     user.companyStatus === 'pending' ? 'bg-amber-100 text-amber-800' :
//                       'bg-rose-100 text-rose-800'
//                     }`}>
